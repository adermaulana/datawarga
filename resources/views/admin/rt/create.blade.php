                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="live-preview">
                                <form class="row g-3 " action="/admin/rt" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">NAMA</label>
                                        <input type="text" class="form-control" name="nama_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="password" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label>AGAMA</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="keterangan_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">DESA</label>
                                        <input type="text" class="form-control" name="desa_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">KECAMATAN</label>
                                        <input type="text" class="form-control" name="kecamatan_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">KABUPATEN/KOTA</label>
                                        <input type="text" class="form-control" name="kota_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">PROVINSI</label>
                                        <input type="text" class="form-control" name="provinsi_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">NEGARA</label>
                                        <input type="text" class="form-control" name="negara_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">RT</label>
                                        <input type="text" class="form-control" name="rt_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">RW</label>
                                        <input type="text" class="form-control" name="rw_rt" id="validationDefault01"
                                               value="" required>
                                    </div>
                            </div>
                            <div class="row">
