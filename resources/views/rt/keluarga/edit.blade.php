                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="live-preview">
                                <form class="row g-3 " action="/rt/keluarga/{{ $keluarga->id_keluarga }}" method="POST" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="nomor_kartu_keluarga" id="validationDefault01"
                                            value="{{ $keluarga->nomor_kartu_keluarga }}" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label>ID WARGA</label>
                                        <select class="form-control" name="id_warga" required>
                                            <option value="{{ $keluarga->id_warga }}" selected>{{ $keluarga->warga->nama_warga }}</option>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="rt_keluarga" value="{{ $keluarga->rt_keluarga }}" readonly id="validationDefault01">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        value="{{ $keluarga->rw_keluarga }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="desa_keluarga" id="validationDefault01"
                                               value="{{ $keluarga->desa_keluarga }}" required>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="kecamatan_keluarga" id="validationDefault01"
                                               value="{{ $keluarga->kecamatan_keluarga }}" required>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="kota_keluarga" id="validationDefault01"
                                               value="{{ $keluarga->kota_keluarga }}" required>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="provinsi_keluarga" id="validationDefault01"
                                               value="{{ $keluarga->provinsi_keluarga }}" required>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="negara_keluarga" id="validationDefault01"
                                               value="{{ $keluarga->negara_keluarga }}" required>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="kode_keluarga" id="validationDefault01"
                                               value="{{ $keluarga->kode_keluarga }}" required>
                                    </div>
                            </div>
                            <div class="row">
                                <div class="mt-4">
