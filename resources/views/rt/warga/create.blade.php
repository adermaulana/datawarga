                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">TAMBAH DATA WARGA</h4>
                                            </div>
                                        </div><!-- end card header -->
                                    </div>
                                    <!--end col-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form class="row g-3 " action="/rt/warga" method="POST" enctype="multipart/form-data">
                                            @csrf
                                             <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">NIK</label>
                                                <input type="text" class="form-control" name="nik_warga" id="validationDefault01" value="" required>
                                            </div> 
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">NAMA</label>
                                                <input type="text" class="form-control" name="nama_warga" id="validationDefault01" value="" required>
                                            </div> 
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">TEMPAT LAHIR</label>
                                                <input type="text" class="form-control" name="tempat_lahir_warga" id="validationDefault01" value="" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">TANGGAL LAHIR</label>
                                                <input type="date" class="form-control" name="tanggal_lahir_warga" id="validationDefault01" value="" required>
                                            </div>
                                            <div class="col-md-12">
                                             ...
                                             <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="alamat_warga" id="validationDefault01" value="" required>
                                            </div>
                                            
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">RT</label>
                                                <input type="number" class="form-control" name="rt_warga" id="validationDefault01"  value="{{ $rt->rt_rt }}" readonly>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">RW</label>
                                                <input type="number" class="form-control" name="rw_warga" id="validationDefault01" value="" required>
                                            </div>
                                            
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">DESA</label>
                                                <input type="text" class="form-control" name="desa_warga" id="validationDefault01" value="" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">KECAMATAN</label>
                                                <input type="text" class="form-control" name="kecamatan_warga" id="validationDefault01" value="" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">KABUPATEN/KOTA</label>
                                                <input type="text" class="form-control" name="kabupaten_warga" id="validationDefault01" value="" required>
                                            </div>
                                            <div class="col-md-12">
                                                    <label>AGAMA</label>
                                            ...
                                            <div class="col-md-12">
                                             ...
                                             <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="pekerjaan_warga" id="validationDefault01" value="" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">NEGARA</label>
                                                <input type="text" class="form-control" name="negara_warga" id="validationDefault01" value="" required>
                                            </div>
                                            </div>
                                            <div class="row">
                                                <div class="mt-4">
                                                    <button class="btn btn-primary" name="simpan" type="submit">SUBMIT</button>
                                                    <button class="btn btn-danger" href="rt/warga" type="reset">BATAL</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
