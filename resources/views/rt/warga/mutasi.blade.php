                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">MUTASI DATA WARGA</h4>
                                            </div>
                                        </div><!-- end card header -->
                                    </div>
                                    <!--end col-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form class="row g-3 " action="/rt/warga/mutasi" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">NIK</label>
                                                    <input type="text" class="form-control" name="nik_mutasi" id="validationDefault01" value="{{ $warga->nik_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">NAMA</label>
                                                    <input type="text" class="form-control" name="nama_mutasi" id="validationDefault01" value="{{ $warga->nama_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">TEMPAT LAHIR</label>
                                                    <input type="text" class="form-control" name="tempat_lahir_mutasi" id="validationDefault01" value="{{ $warga->tempat_lahir_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">TANGGAL LAHIR</label>
                                                    <input type="date" class="form-control" name="tanggal_lahir_mutasi" id="validationDefault01" value="{{ $warga->tanggal_lahir_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="alamat_mutasi" id="validationDefault01" value="{{ $warga->alamat_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">RT</label>
                                                    <input type="number" class="form-control" name="rt_mutasi" id="validationDefault01" value="{{ $warga->rt_warga }}" readonly>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">RW</label>
                                                    <input type="number" class="form-control" name="rw_mutasi" id="validationDefault01" value="{{ $warga->rw_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">DESA</label>
                                                    <input type="text" class="form-control" name="desa_mutasi" id="validationDefault01" value="{{ $warga->desa_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">KECAMATAN</label>
                                                    <input type="text" class="form-control" name="kecamatan_mutasi" id="validationDefault01" value="{{ $warga->kecamatan_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">KABUPATEN/KOTA</label>
                                                    <input type="text" class="form-control" name="kabupaten_mutasi" id="validationDefault01" value="{{ $warga->kabupaten_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label>AGAMA</label>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="pekerjaan_mutasi" id="validationDefault01" value="{{ $warga->pekerjaan_warga }}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="validationDefault01" class="form-label">NEGARA</label>
                                                    <input type="text" class="form-control" name="negara_mutasi" id="validationDefault01" value="{{ $warga->negara_warga }}" required>
                                                </div>
                                            <div class="row">
                                                <div class="mt-4">
